...
public:
  ...
  OtherClass(Animals animals, QObject *parent = nullptr) : QObject(parent), m_animals(animals) {}
...
void TestBuiltinSyntax::testEnums_data()
{
  ...
  QTest::newRow("enums-compare09")
          << QStringLiteral("{% if var.animals < var3.animals %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;

  QTest::newRow("enums-compare10")
          << QStringLiteral("{% if var.animals < var2.animals %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;
  ...
  QTest::newRow("gadget-enums-compare01")
          << QStringLiteral("{% if var.personName == var3.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("true") << NoError;

  QTest::newRow("gadget-enums-compare02")
          << QStringLiteral("{% if var.personName == var2.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;
  ...
  QTest::newRow("gadget-enums-compare05")
          << QStringLiteral("{% if var.personName > var3.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;

  QTest::newRow("gadget-enums-compare06")
          << QStringLiteral("{% if var.personName > var2.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("true") << NoError;
  ...
  QTest::newRow("gadget-enums-compare09")
          << QStringLiteral("{% if var.personName < var3.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;

  QTest::newRow("gadget-enums-compare10")
          << QStringLiteral("{% if var.personName < var2.personName %}true{% else %}false{% endif %}") << dict
          << QStringLiteral("false") << NoError;
}
